...
public class AffichageTournoi32Controller implements Initializable {
    ...
    @FXML
    private Circle match16;
    @FXML
    private Circle match17;
    @FXML
    private Circle match18;
    @FXML
    private Circle match19;
    @FXML
    private Circle match20;
    @FXML
    private Circle match21;
    @FXML
    private Circle match22;
    @FXML
    private Circle match23;
    @FXML
    private Circle match24;
    @FXML
    private Circle match25;
    @FXML
    private Circle match26;
    @FXML
    private Circle match27;
    @FXML
    private Circle match28;
    @FXML
