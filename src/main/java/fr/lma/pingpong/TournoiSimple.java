...
public class TournoiSimple extends Tournoi {
     ...
     */
    public TournoiSimple(String p_nom, LocalDate p_dateDebut, LocalDate p_dateFin, int p_nbJoueurs, ArrayList<Match> p_matchs, ArrayList<Joueur> p_joueurs, String p_stade, String p_ville) {
